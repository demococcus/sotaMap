var rilaSotaPeaks = {"type":"FeatureCollection","features":[
...
var map = new maplibregl.Map({
    ...
    center:[23.50206819,42.15451878],
    zoom:10
});
...
map.on('load', function () {
    ...
    map.on('click', 'places', function (e) {
        ...
        var sotaID = e.features[0].properties.sota;
        var gowhere = e.features[0].properties.gowhere;
        ...
        if (sotaID != undefined) {
            content += "<p><a href='https://sotl.as/summits/"+sotaID+"' target='_blank'>"+sotaID+"</a></p>"
        }
        if (gowhere != undefined) {
            content += "<p><a href='"+gowhere+"' target='_blank'>GOWHERE</a></p>"
        }
...
function toggleBackgroundMap() {
    ...
    const bgmapsVisible = map.getLayoutProperty('bgmountains-tiles', 'visibility');
    if (bgmapsVisible == 'visible') {
        map.setLayoutProperty('bgmountains-tiles', 'visibility', 'none');
        map.setLayoutProperty('opentopo-tiles', 'visibility', 'visible');
    } else {
        map.setLayoutProperty('bgmountains-tiles', 'visibility', 'visible');
        map.setLayoutProperty('opentopo-tiles', 'visibility', 'none');
    }
